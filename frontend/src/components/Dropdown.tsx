...
export function Dropdown({ options, onChange, value }: { options: string[], onChange: (value: string) => void, value: string; }) {
  return (
    <Listbox value={value} onChange={onChange}>
      <div className='relative min-w-40 mr-4'>
        <Listbox.Button
        ...
        >
          <span className='block truncate capitalize text-black'>{value}</span>
